...
import { SavedFiltersPageComponent } from './pages/saved-filters-page.component';
...
export const routes: Routes = [
  ...
  { path: 'saved-filters', component: SavedFiltersPageComponent, canActivate: [authGuard, roleGuard(['buyer','admin'])] },
];
